<?php
/**
 * FullwidthSectionCarousel::module_classnames().
 *
...
trait ModuleClassnamesTrait {
	...
	/**
	 * Module classnames function for FullwidthSectionCarousel module.
	 *
	 * @since ??
	 *
	 * @param array $args {
	...
	public static function module_classnames( $args ) {
		...
		$classnames_instance->add( 'carousel', true );
		$classnames_instance->add( 'slide', true );
