...
class Card implements DependencyInterface {
	...
	/**
	 * Loads `Card` and registers Front-End render callback and REST API Endpoints.
	 *
	 * @since ??
	 *
	 * @return void
	...
	public function load() {
		$module_json_folder_path = CAWEB_DIVI_EXT_MODULES_JSON_PATH . 'Card/';
		...
		add_action(
			...
			function() use ( $module_json_folder_path ) {
				ModuleRegistration::register_module(
					...
					[
						'render_callback' => [ Card::class, 'render_callback' ],
					]
				);
			}
		);
