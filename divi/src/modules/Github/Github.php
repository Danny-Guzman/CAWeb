...
namespace CAWeb\Modules\Github;
...
class Github extends CAWebModule {
	...
	/**
	 * Loads `Github` and registers Front-End render callback and REST API Endpoints.
	 *
	 * @since ??
	 *
	 * @return void
	...
	public function load() {
		$module_json_folder_path = CAWEB_DIVI_EXT_MODULES_JSON_PATH . 'Github/';
		...
		add_action(
			...
			function() use ( $module_json_folder_path ) {
				ModuleRegistration::register_module(
					...
					[
						'render_callback' => [ Github::class, 'render_callback' ],
					]
				);
			}
		);
